...
export function LogoCloud() {
  return (
    <Sec bg={T.offWhite} style={{ padding: "clamp(40px, 6vh, 64px) 0" }}>
      <p style={{ fontFamily: "'Inter',sans-serif", fontSize: 10, letterSpacing: "0.2em", textTransform: "uppercase", color: T.slateLight, textAlign: "center", marginBottom: 36 }}>
          ...
          >
            {logo ? (
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
                <span style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "clamp(18px, 2.5vw, 26px)", fontWeight: 600, letterSpacing: "0.04em", color: T.navy, whiteSpace: "nowrap" }}>
                  {abbr}
                </span>
                <span style={{ fontFamily: "'Inter',sans-serif", fontSize: 9, letterSpacing: "0.12em", textTransform: "uppercase", color: T.slateLight, whiteSpace: "nowrap" }}>
                  {name}
                </span>
              </div>
            )}
