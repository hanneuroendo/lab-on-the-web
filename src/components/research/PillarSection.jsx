    ...
    <Sec bg={index % 2 === 0 ? T.offWhite : T.white}>
      ...
      >
        ...
        <div className="pillar-sticky">
          ...
          <span style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 72, fontWeight: 300, color: "rgba(61,143,166,0.2)", lineHeight: 1, display: "block", marginBottom: 8 }}>
            {pillar.num}
          </span>
          <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "clamp(22px,2.5vw,30px)", fontWeight: 500, color: T.navy, marginBottom: 20, lineHeight: 1.15 }}>
            {pillar.title}
          </h2>
