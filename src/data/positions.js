export const POSITIONS = [
  {
    ...
    icon: "flask",
    status: "Open",
    desc: "Join the Han Lab to provide technical and experimental support to a Wellcome Trust-funded research project. This role involves animal care, laboratory procedures, and maintaining efficient lab operations within the School of Psychology and Neuroscience.",
    reqs: [
      ...
      "Experience in or willingness to work with animal models and undertake procedures involving laboratory mice",
      "Ability to work both independently and as part of a collaborative research team",
      "Competent IT skills for data recording, documentation, and communication",
    ],
